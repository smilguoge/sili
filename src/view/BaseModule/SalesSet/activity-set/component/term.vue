          ...
          <div class="tables">
            <div v-for="(item,index) in projectPackge" :key="index" class="m-table">
              <el-form ref="filterForm">
                <div class="m-header">
                  <el-form-item>
                    <el-input v-model="item.date_num" style="width:50px" type="number" />
                    <el-select v-model="item.date_type" placeholder="请选择">
                      <el-option v-for="types in dataObj.arrDateType" :key="types.code" :label="types.name" :value="types.code" />
                    </el-select>
                  </el-form-item>
                  <el-form-item>
                    最高护理次数<el-input v-model="item.nurse_maximum" style="width:50px" type="number" />
                  </el-form-item>
                  <el-form-item>
                    销售总金额<el-input v-model="item.total_sales" style="width:50px" type="number" />
                  </el-form-item>
                  <el-form-item>
                    财耗次数<el-input v-model="item.consume_money_num" style="width:50px" type="number" />
                  </el-form-item>
                  <el-form-item>
                ...
                <div class="m-content">
                  ...
                  >
                    ...
                    <el-table-column align="center" label="最多项目次数">
    ...
    submitForm(formName) {
      if (this.givePackge.length > 0 || this.projectPackge.length > 0) {
        ...
        const query = {
          ...
          card_package_type: this.card_package_type,
          total_num: this.total_num ? this.total_num : 0,
          total_amount: this.total_amount ? this.total_amount : 0,

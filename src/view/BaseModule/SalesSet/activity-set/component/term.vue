          ...
          <div class="tables">
            <div class="m-table" v-for="(item,i) in optionsForm.pcom" :key="i">
              <el-form ref="filterForm" :model="optionsForm.pcom[item]" :inline="true">
                <div class="m-header">
                  <el-form-item>
                    <el-checkbox v-model="optionsForm.pcom.checked" style="padding:0 5px"></el-checkbox>
                  </el-form-item>
                  <el-form-item>
                    <el-input v-model="optionsForm.pcom.name"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-input v-model="optionsForm.pcom.total_num" style="width:50px"></el-input>选择
                    <el-input v-model="optionsForm.pcom.select_num" style="width:50px"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-radio-group v-model="optionsForm.pcom.is_combination_type">
                ...
                <div class="m-content">
                  ...
                  >
                    ...
                    <el-table-column prop="goods_name" label="品项名称" min-width="25%" align="center"></el-table-column>
                    <el-table-column prop="least_num" label="最少购买次数" min-width="25%" align="center"></el-table-column>
                    <el-table-column
                      prop="atmost_num"
                      label="最多购买次数"
                      min-width="25%"

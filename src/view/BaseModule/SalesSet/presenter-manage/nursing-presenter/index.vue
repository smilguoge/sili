    ...
    <el-table :data="tableList" style="width: 100%" height="300px" max-height="350px">
      ...
      <el-table-column>
        ...
        <template slot-scope="scope">
          ...
          {{scope.row.is_consume_add==1?'累计达到'+scope.row.consume_add+'财耗':''}}
          {{scope.row.is_consume_max==1?'单次最高'+scope.row.consume_max+'财耗':''}}
...
<script>
import nursingCondition from "./nursing-condition/index";

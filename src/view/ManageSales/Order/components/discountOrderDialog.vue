<template>
  ...
  >
    ...
    <order-item-dialog v-model="itemVisible" @cancel="handleChildCancel" />
  </el-dialog>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.$parent.discountOrderVisible = false
    }
  }
}
</script>
